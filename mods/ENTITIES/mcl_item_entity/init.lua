...
item_drop_settings.fluid_drag            = 0.5 --how much drag water has on items (how quickly an item's motion will settle onto the water's flow speed)
item_drop_settings.ground_drag           = 1.5 --how much friction with the ground slows items sliding on it
